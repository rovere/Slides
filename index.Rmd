...
1. Buy performing/expensive dedicated hardware
...
- While buying new hardware is a legitimate step, it is clear that it
...
- <font class='blue bold'>Need to find adequate replacements, trying
...
- Invest in software (horizontal scaling)
   - Swap the current back-end with a viable distributed back-end
   - Modify the current back-end to be a distributed back-end




|                                        | Hardware                                                                                                     | Software/Open Source distributed back-end                                                                                | Software/Make current back-end distributed                       |
|----------------------------------------|--------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------- |
...
Moving the current production servers to Virtual Machines is not an immediate step.
...
- <font class='yellow bold'>Good occasion to re-think a bit the DQM GUI applications and give a
  thought about what could be done to cope with less performing
...
* This could be done allowing the web server to concurrently handle
  ...
  point to separate folders with unique <font class='yellow
  bold'>aliases</font>.
...
* The real challenge here is to be sure to <font class='red
  ...
  back-end</font>. Could be handled by a persistent catalog on the
  web-server and an ad-hoc agent.
