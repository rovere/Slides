...
* The plot on the left shows probability that the first reconstructed
  ...
  vertex has not been reconstructed, or that it was not the one with
...
* Preliminary studies on a small sample in 72pre3 70PU@25ns show that
  the vertex reconstruction is behaving as expected.
...
* More advanced studies on vertex reconstruction in 72 will be done in
  the coming future.
