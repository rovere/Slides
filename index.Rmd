...
- Invest in software (horizontal scaling)
   - Swap the current backend with a viable ditributed backend
   - Modify the current backend to be a distributed backend

### Hardware

- <font class='red'>Expensive</font>
- <font class='red'>Not the preferred solution from IT</font>
- <font class='red'>Additional load on us, since they would outsource the
  configuration/handling/alarming of commodity hardware</font>

### Software - Open Source distributed backend
- <font class='blue bold'>Solid rock/tested/community supported software</font>
- <font class='red bold'>Big evaluation time, development integration,
  steep learning curve</font> (see, e.g., ongoing effort for
  Conditions in CMSSW)
- <font class='yellow3 bold'>PREFERRED CHOICE FOR LONG TERM</font> (technical student?)
...
### Software - Make current backend "distributed"
- <font class='red bold'>Non-negligible development effort</font>
- <font class='blue bold'>Start from a solid-rock code</font>
- <font class='blue bold'>Affordable learning curve</font>
- <font class='green bold'>PREFERRED CHOICE FOR SHORT TERM</font>
